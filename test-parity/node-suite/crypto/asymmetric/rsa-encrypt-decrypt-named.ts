...
const plaintext = Buffer.from("named rsa oaep parity");
const ciphertext = publicEncrypt(publicKey, plaintext);
const decrypted = privateDecrypt(privateKey, ciphertext);

console.log("named cipher length:", ciphertext.length);
console.log("named decrypt:", decrypted.toString());
