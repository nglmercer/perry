...
signer.update("named streaming rsa");
const signature = signer.sign(privateKey);

const verifier = createVerify("RSA-SHA384");
verifier.update("named streaming rsa");

console.log("named stream sig length:", signature.length);
console.log("named stream verify:", verifier.verify(publicKey, signature));
