...
// Module #169 in the #808 init-scale chain. Each module imports its
...
const _chain_169: number = VAL_168 + 1;
if (_chain_169 < 0) throw new Error("chain check");
export const VAL_169: number = 1169;

export class Cls_169 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_169`
