...
// Module #071 in the #808 init-scale chain. Each module imports its
...
const _chain_071: number = VAL_070 + 1;
if (_chain_071 < 0) throw new Error("chain check");
export const VAL_071: number = 1071;

export class Cls_071 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_071`
