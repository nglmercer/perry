...
// Module #276 in the #808 init-scale chain. Each module imports its
...
const _chain_276: number = VAL_275 + 1;
if (_chain_276 < 0) throw new Error("chain check");
export const VAL_276: number = 1276;

export class Cls_276 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_276`
