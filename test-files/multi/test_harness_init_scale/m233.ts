...
// Module #233 in the #808 init-scale chain. Each module imports its
...
const _chain_233: number = VAL_232 + 1;
if (_chain_233 < 0) throw new Error("chain check");
export const VAL_233: number = 1233;

export class Cls_233 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_233`
