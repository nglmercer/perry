...
// Module #211 in the #808 init-scale chain. Each module imports its
...
const _chain_211: number = VAL_210 + 1;
if (_chain_211 < 0) throw new Error("chain check");
export const VAL_211: number = 1211;

export class Cls_211 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_211`
