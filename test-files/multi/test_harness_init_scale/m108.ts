...
// Module #108 in the #808 init-scale chain. Each module imports its
...
const _chain_108: number = VAL_107 + 1;
if (_chain_108 < 0) throw new Error("chain check");
export const VAL_108: number = 1108;

export class Cls_108 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_108`
