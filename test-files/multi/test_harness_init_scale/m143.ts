...
// Module #143 in the #808 init-scale chain. Each module imports its
...
const _chain_143: number = VAL_142 + 1;
if (_chain_143 < 0) throw new Error("chain check");
export const VAL_143: number = 1143;

export class Cls_143 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_143`
