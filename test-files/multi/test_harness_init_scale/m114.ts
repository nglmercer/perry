...
// Module #114 in the #808 init-scale chain. Each module imports its
...
const _chain_114: number = VAL_113 + 1;
if (_chain_114 < 0) throw new Error("chain check");
export const VAL_114: number = 1114;

export class Cls_114 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_114`
