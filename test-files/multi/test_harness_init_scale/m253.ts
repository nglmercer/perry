...
// Module #253 in the #808 init-scale chain. Each module imports its
...
const _chain_253: number = VAL_252 + 1;
if (_chain_253 < 0) throw new Error("chain check");
export const VAL_253: number = 1253;

export class Cls_253 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_253`
