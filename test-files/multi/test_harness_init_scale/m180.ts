...
// Module #180 in the #808 init-scale chain. Each module imports its
...
const _chain_180: number = VAL_179 + 1;
if (_chain_180 < 0) throw new Error("chain check");
export const VAL_180: number = 1180;

export class Cls_180 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_180`
