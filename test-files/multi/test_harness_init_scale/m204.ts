...
// Module #204 in the #808 init-scale chain. Each module imports its
...
const _chain_204: number = VAL_203 + 1;
if (_chain_204 < 0) throw new Error("chain check");
export const VAL_204: number = 1204;

export class Cls_204 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_204`
