...
// Module #067 in the #808 init-scale chain. Each module imports its
...
const _chain_067: number = VAL_066 + 1;
if (_chain_067 < 0) throw new Error("chain check");
export const VAL_067: number = 1067;

export class Cls_067 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_067`
