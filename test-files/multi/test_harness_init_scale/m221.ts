...
// Module #221 in the #808 init-scale chain. Each module imports its
...
const _chain_221: number = VAL_220 + 1;
if (_chain_221 < 0) throw new Error("chain check");
export const VAL_221: number = 1221;

export class Cls_221 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_221`
