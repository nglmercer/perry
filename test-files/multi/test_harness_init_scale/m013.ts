...
// Module #013 in the #808 init-scale chain. Each module imports its
...
const _chain_013: number = VAL_012 + 1;
if (_chain_013 < 0) throw new Error("chain check");
export const VAL_013: number = 1013;

export class Cls_013 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_013`
