...
// Module #172 in the #808 init-scale chain. Each module imports its
...
const _chain_172: number = VAL_171 + 1;
if (_chain_172 < 0) throw new Error("chain check");
export const VAL_172: number = 1172;

export class Cls_172 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_172`
