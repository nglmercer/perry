...
// Module #011 in the #808 init-scale chain. Each module imports its
...
const _chain_011: number = VAL_010 + 1;
if (_chain_011 < 0) throw new Error("chain check");
export const VAL_011: number = 1011;

export class Cls_011 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_011`
