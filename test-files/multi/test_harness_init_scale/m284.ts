...
// Module #284 in the #808 init-scale chain. Each module imports its
...
const _chain_284: number = VAL_283 + 1;
if (_chain_284 < 0) throw new Error("chain check");
export const VAL_284: number = 1284;

export class Cls_284 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_284`
