...
// Module #184 in the #808 init-scale chain. Each module imports its
...
const _chain_184: number = VAL_183 + 1;
if (_chain_184 < 0) throw new Error("chain check");
export const VAL_184: number = 1184;

export class Cls_184 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_184`
