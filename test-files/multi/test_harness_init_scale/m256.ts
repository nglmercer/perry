...
// Module #256 in the #808 init-scale chain. Each module imports its
...
const _chain_256: number = VAL_255 + 1;
if (_chain_256 < 0) throw new Error("chain check");
export const VAL_256: number = 1256;

export class Cls_256 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_256`
