...
// Module #188 in the #808 init-scale chain. Each module imports its
...
const _chain_188: number = VAL_187 + 1;
if (_chain_188 < 0) throw new Error("chain check");
export const VAL_188: number = 1188;

export class Cls_188 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_188`
