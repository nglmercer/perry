...
// Module #272 in the #808 init-scale chain. Each module imports its
...
const _chain_272: number = VAL_271 + 1;
if (_chain_272 < 0) throw new Error("chain check");
export const VAL_272: number = 1272;

export class Cls_272 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_272`
