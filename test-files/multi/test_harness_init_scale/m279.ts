...
// Module #279 in the #808 init-scale chain. Each module imports its
...
const _chain_279: number = VAL_278 + 1;
if (_chain_279 < 0) throw new Error("chain check");
export const VAL_279: number = 1279;

export class Cls_279 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_279`
