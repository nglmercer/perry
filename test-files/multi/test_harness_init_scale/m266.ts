...
// Module #266 in the #808 init-scale chain. Each module imports its
...
const _chain_266: number = VAL_265 + 1;
if (_chain_266 < 0) throw new Error("chain check");
export const VAL_266: number = 1266;

export class Cls_266 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_266`
