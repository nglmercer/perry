...
// Module #036 in the #808 init-scale chain. Each module imports its
...
const _chain_036: number = VAL_035 + 1;
if (_chain_036 < 0) throw new Error("chain check");
export const VAL_036: number = 1036;

export class Cls_036 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_036`
