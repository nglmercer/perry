...
// Module #094 in the #808 init-scale chain. Each module imports its
...
const _chain_094: number = VAL_093 + 1;
if (_chain_094 < 0) throw new Error("chain check");
export const VAL_094: number = 1094;

export class Cls_094 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_094`
