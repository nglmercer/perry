...
// Module #200 in the #808 init-scale chain. Each module imports its
...
const _chain_200: number = VAL_199 + 1;
if (_chain_200 < 0) throw new Error("chain check");
export const VAL_200: number = 1200;

export class Cls_200 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_200`
