...
// Module #128 in the #808 init-scale chain. Each module imports its
...
const _chain_128: number = VAL_127 + 1;
if (_chain_128 < 0) throw new Error("chain check");
export const VAL_128: number = 1128;

export class Cls_128 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_128`
