...
// Module #049 in the #808 init-scale chain. Each module imports its
...
const _chain_049: number = VAL_048 + 1;
if (_chain_049 < 0) throw new Error("chain check");
export const VAL_049: number = 1049;

export class Cls_049 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_049`
