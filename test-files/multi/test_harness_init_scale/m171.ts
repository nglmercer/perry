...
// Module #171 in the #808 init-scale chain. Each module imports its
...
const _chain_171: number = VAL_170 + 1;
if (_chain_171 < 0) throw new Error("chain check");
export const VAL_171: number = 1171;

export class Cls_171 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_171`
