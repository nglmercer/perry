...
// Module #029 in the #808 init-scale chain. Each module imports its
...
const _chain_029: number = VAL_028 + 1;
if (_chain_029 < 0) throw new Error("chain check");
export const VAL_029: number = 1029;

export class Cls_029 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_029`
