...
// Module #070 in the #808 init-scale chain. Each module imports its
...
const _chain_070: number = VAL_069 + 1;
if (_chain_070 < 0) throw new Error("chain check");
export const VAL_070: number = 1070;

export class Cls_070 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_070`
