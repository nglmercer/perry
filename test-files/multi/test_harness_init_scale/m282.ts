...
// Module #282 in the #808 init-scale chain. Each module imports its
...
const _chain_282: number = VAL_281 + 1;
if (_chain_282 < 0) throw new Error("chain check");
export const VAL_282: number = 1282;

export class Cls_282 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_282`
