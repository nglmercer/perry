...
// Module #234 in the #808 init-scale chain. Each module imports its
...
const _chain_234: number = VAL_233 + 1;
if (_chain_234 < 0) throw new Error("chain check");
export const VAL_234: number = 1234;

export class Cls_234 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_234`
