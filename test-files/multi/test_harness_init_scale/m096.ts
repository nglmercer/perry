...
// Module #096 in the #808 init-scale chain. Each module imports its
...
const _chain_096: number = VAL_095 + 1;
if (_chain_096 < 0) throw new Error("chain check");
export const VAL_096: number = 1096;

export class Cls_096 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_096`
