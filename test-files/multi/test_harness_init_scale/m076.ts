...
// Module #076 in the #808 init-scale chain. Each module imports its
...
const _chain_076: number = VAL_075 + 1;
if (_chain_076 < 0) throw new Error("chain check");
export const VAL_076: number = 1076;

export class Cls_076 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_076`
