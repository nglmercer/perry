...
// Module #077 in the #808 init-scale chain. Each module imports its
...
const _chain_077: number = VAL_076 + 1;
if (_chain_077 < 0) throw new Error("chain check");
export const VAL_077: number = 1077;

export class Cls_077 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_077`
