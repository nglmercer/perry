...
// Module #065 in the #808 init-scale chain. Each module imports its
...
const _chain_065: number = VAL_064 + 1;
if (_chain_065 < 0) throw new Error("chain check");
export const VAL_065: number = 1065;

export class Cls_065 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_065`
