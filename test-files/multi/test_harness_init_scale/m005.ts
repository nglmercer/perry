...
// Module #005 in the #808 init-scale chain. Each module imports its
...
const _chain_005: number = VAL_004 + 1;
if (_chain_005 < 0) throw new Error("chain check");
export const VAL_005: number = 1005;

export class Cls_005 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_005`
