...
// Module #288 in the #808 init-scale chain. Each module imports its
...
const _chain_288: number = VAL_287 + 1;
if (_chain_288 < 0) throw new Error("chain check");
export const VAL_288: number = 1288;

export class Cls_288 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_288`
