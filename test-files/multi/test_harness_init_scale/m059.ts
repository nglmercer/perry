...
// Module #059 in the #808 init-scale chain. Each module imports its
...
const _chain_059: number = VAL_058 + 1;
if (_chain_059 < 0) throw new Error("chain check");
export const VAL_059: number = 1059;

export class Cls_059 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_059`
