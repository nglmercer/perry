...
// Module #268 in the #808 init-scale chain. Each module imports its
...
const _chain_268: number = VAL_267 + 1;
if (_chain_268 < 0) throw new Error("chain check");
export const VAL_268: number = 1268;

export class Cls_268 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_268`
