...
// Module #192 in the #808 init-scale chain. Each module imports its
...
if (_chain_192 < 0) throw new Error("chain check");
export const VAL_192: number = 1192;

export class Cls_192 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_192`
