...
// Module #160 in the #808 init-scale chain. Each module imports its
...
const _chain_160: number = VAL_159 + 1;
if (_chain_160 < 0) throw new Error("chain check");
export const VAL_160: number = 1160;

export class Cls_160 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_160`
