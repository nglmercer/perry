...
// Module #118 in the #808 init-scale chain. Each module imports its
...
const _chain_118: number = VAL_117 + 1;
if (_chain_118 < 0) throw new Error("chain check");
export const VAL_118: number = 1118;

export class Cls_118 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_118`
