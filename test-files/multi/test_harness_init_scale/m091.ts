...
// Module #091 in the #808 init-scale chain. Each module imports its
...
const _chain_091: number = VAL_090 + 1;
if (_chain_091 < 0) throw new Error("chain check");
export const VAL_091: number = 1091;

export class Cls_091 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_091`
