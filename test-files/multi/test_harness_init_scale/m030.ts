...
// Module #030 in the #808 init-scale chain. Each module imports its
...
const _chain_030: number = VAL_029 + 1;
if (_chain_030 < 0) throw new Error("chain check");
export const VAL_030: number = 1030;

export class Cls_030 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_030`
