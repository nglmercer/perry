...
// Module #247 in the #808 init-scale chain. Each module imports its
...
const _chain_247: number = VAL_246 + 1;
if (_chain_247 < 0) throw new Error("chain check");
export const VAL_247: number = 1247;

export class Cls_247 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_247`
