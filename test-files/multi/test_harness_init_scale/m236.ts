...
// Module #236 in the #808 init-scale chain. Each module imports its
...
const _chain_236: number = VAL_235 + 1;
if (_chain_236 < 0) throw new Error("chain check");
export const VAL_236: number = 1236;

export class Cls_236 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_236`
