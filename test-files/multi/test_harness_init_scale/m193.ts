...
// Module #193 in the #808 init-scale chain. Each module imports its
...
const _chain_193: number = VAL_192 + 1;
if (_chain_193 < 0) throw new Error("chain check");
export const VAL_193: number = 1193;

export class Cls_193 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_193`
