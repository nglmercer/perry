...
// Module #053 in the #808 init-scale chain. Each module imports its
...
const _chain_053: number = VAL_052 + 1;
if (_chain_053 < 0) throw new Error("chain check");
export const VAL_053: number = 1053;

export class Cls_053 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_053`
