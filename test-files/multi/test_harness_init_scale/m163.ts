...
// Module #163 in the #808 init-scale chain. Each module imports its
...
const _chain_163: number = VAL_162 + 1;
if (_chain_163 < 0) throw new Error("chain check");
export const VAL_163: number = 1163;

export class Cls_163 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_163`
