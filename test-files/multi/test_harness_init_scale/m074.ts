...
// Module #074 in the #808 init-scale chain. Each module imports its
...
const _chain_074: number = VAL_073 + 1;
if (_chain_074 < 0) throw new Error("chain check");
export const VAL_074: number = 1074;

export class Cls_074 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_074`
