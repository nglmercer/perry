...
// Module #078 in the #808 init-scale chain. Each module imports its
...
const _chain_078: number = VAL_077 + 1;
if (_chain_078 < 0) throw new Error("chain check");
export const VAL_078: number = 1078;

export class Cls_078 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_078`
