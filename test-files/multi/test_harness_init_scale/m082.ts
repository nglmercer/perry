...
// Module #082 in the #808 init-scale chain. Each module imports its
...
const _chain_082: number = VAL_081 + 1;
if (_chain_082 < 0) throw new Error("chain check");
export const VAL_082: number = 1082;

export class Cls_082 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_082`
