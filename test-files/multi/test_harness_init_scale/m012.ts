...
// Module #012 in the #808 init-scale chain. Each module imports its
...
const _chain_012: number = VAL_011 + 1;
if (_chain_012 < 0) throw new Error("chain check");
export const VAL_012: number = 1012;

export class Cls_012 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_012`
