...
// Module #218 in the #808 init-scale chain. Each module imports its
...
const _chain_218: number = VAL_217 + 1;
if (_chain_218 < 0) throw new Error("chain check");
export const VAL_218: number = 1218;

export class Cls_218 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_218`
