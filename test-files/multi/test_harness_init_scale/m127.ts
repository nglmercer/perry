...
// Module #127 in the #808 init-scale chain. Each module imports its
...
const _chain_127: number = VAL_126 + 1;
if (_chain_127 < 0) throw new Error("chain check");
export const VAL_127: number = 1127;

export class Cls_127 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_127`
