...
// Module #148 in the #808 init-scale chain. Each module imports its
...
const _chain_148: number = VAL_147 + 1;
if (_chain_148 < 0) throw new Error("chain check");
export const VAL_148: number = 1148;

export class Cls_148 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_148`
