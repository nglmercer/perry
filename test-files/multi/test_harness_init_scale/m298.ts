...
// Module #298 in the #808 init-scale chain. Each module imports its
...
const _chain_298: number = VAL_297 + 1;
if (_chain_298 < 0) throw new Error("chain check");
export const VAL_298: number = 1298;

export class Cls_298 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_298`
