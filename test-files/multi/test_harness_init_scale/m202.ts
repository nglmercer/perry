...
// Module #202 in the #808 init-scale chain. Each module imports its
...
const _chain_202: number = VAL_201 + 1;
if (_chain_202 < 0) throw new Error("chain check");
export const VAL_202: number = 1202;

export class Cls_202 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_202`
