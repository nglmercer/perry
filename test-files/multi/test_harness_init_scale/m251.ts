...
// Module #251 in the #808 init-scale chain. Each module imports its
...
const _chain_251: number = VAL_250 + 1;
if (_chain_251 < 0) throw new Error("chain check");
export const VAL_251: number = 1251;

export class Cls_251 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_251`
