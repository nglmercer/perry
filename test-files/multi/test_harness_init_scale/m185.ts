...
// Module #185 in the #808 init-scale chain. Each module imports its
...
const _chain_185: number = VAL_184 + 1;
if (_chain_185 < 0) throw new Error("chain check");
export const VAL_185: number = 1185;

export class Cls_185 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_185`
