...
// Module #106 in the #808 init-scale chain. Each module imports its
...
const _chain_106: number = VAL_105 + 1;
if (_chain_106 < 0) throw new Error("chain check");
export const VAL_106: number = 1106;

export class Cls_106 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_106`
