...
// Module #290 in the #808 init-scale chain. Each module imports its
...
const _chain_290: number = VAL_289 + 1;
if (_chain_290 < 0) throw new Error("chain check");
export const VAL_290: number = 1290;

export class Cls_290 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_290`
