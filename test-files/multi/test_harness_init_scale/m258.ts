...
// Module #258 in the #808 init-scale chain. Each module imports its
...
const _chain_258: number = VAL_257 + 1;
if (_chain_258 < 0) throw new Error("chain check");
export const VAL_258: number = 1258;

export class Cls_258 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_258`
