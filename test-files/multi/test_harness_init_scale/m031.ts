...
// Module #031 in the #808 init-scale chain. Each module imports its
...
const _chain_031: number = VAL_030 + 1;
if (_chain_031 < 0) throw new Error("chain check");
export const VAL_031: number = 1031;

export class Cls_031 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_031`
