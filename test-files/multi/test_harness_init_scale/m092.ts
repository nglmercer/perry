...
// Module #092 in the #808 init-scale chain. Each module imports its
...
const _chain_092: number = VAL_091 + 1;
if (_chain_092 < 0) throw new Error("chain check");
export const VAL_092: number = 1092;

export class Cls_092 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_092`
