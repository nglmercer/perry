...
// Module #136 in the #808 init-scale chain. Each module imports its
...
const _chain_136: number = VAL_135 + 1;
if (_chain_136 < 0) throw new Error("chain check");
export const VAL_136: number = 1136;

export class Cls_136 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_136`
