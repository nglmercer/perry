...
// Module #032 in the #808 init-scale chain. Each module imports its
...
const _chain_032: number = VAL_031 + 1;
if (_chain_032 < 0) throw new Error("chain check");
export const VAL_032: number = 1032;

export class Cls_032 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_032`
