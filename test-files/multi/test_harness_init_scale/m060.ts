...
// Module #060 in the #808 init-scale chain. Each module imports its
...
const _chain_060: number = VAL_059 + 1;
if (_chain_060 < 0) throw new Error("chain check");
export const VAL_060: number = 1060;

export class Cls_060 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_060`
