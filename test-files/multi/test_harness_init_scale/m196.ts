...
// Module #196 in the #808 init-scale chain. Each module imports its
...
const _chain_196: number = VAL_195 + 1;
if (_chain_196 < 0) throw new Error("chain check");
export const VAL_196: number = 1196;

export class Cls_196 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_196`
