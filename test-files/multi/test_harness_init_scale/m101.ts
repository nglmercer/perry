...
// Module #101 in the #808 init-scale chain. Each module imports its
...
const _chain_101: number = VAL_100 + 1;
if (_chain_101 < 0) throw new Error("chain check");
export const VAL_101: number = 1101;

export class Cls_101 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_101`
