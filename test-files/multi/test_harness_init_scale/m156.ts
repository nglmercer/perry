...
// Module #156 in the #808 init-scale chain. Each module imports its
...
const _chain_156: number = VAL_155 + 1;
if (_chain_156 < 0) throw new Error("chain check");
export const VAL_156: number = 1156;

export class Cls_156 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_156`
