...
// Module #039 in the #808 init-scale chain. Each module imports its
...
const _chain_039: number = VAL_038 + 1;
if (_chain_039 < 0) throw new Error("chain check");
export const VAL_039: number = 1039;

export class Cls_039 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_039`
