...
// Module #014 in the #808 init-scale chain. Each module imports its
...
const _chain_014: number = VAL_013 + 1;
if (_chain_014 < 0) throw new Error("chain check");
export const VAL_014: number = 1014;

export class Cls_014 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_014`
