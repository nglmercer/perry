...
// Module #238 in the #808 init-scale chain. Each module imports its
...
const _chain_238: number = VAL_237 + 1;
if (_chain_238 < 0) throw new Error("chain check");
export const VAL_238: number = 1238;

export class Cls_238 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_238`
