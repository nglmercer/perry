...
// Module #246 in the #808 init-scale chain. Each module imports its
...
const _chain_246: number = VAL_245 + 1;
if (_chain_246 < 0) throw new Error("chain check");
export const VAL_246: number = 1246;

export class Cls_246 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_246`
