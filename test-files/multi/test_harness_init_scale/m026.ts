...
// Module #026 in the #808 init-scale chain. Each module imports its
...
const _chain_026: number = VAL_025 + 1;
if (_chain_026 < 0) throw new Error("chain check");
export const VAL_026: number = 1026;

export class Cls_026 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_026`
