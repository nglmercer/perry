...
// Module #291 in the #808 init-scale chain. Each module imports its
...
const _chain_291: number = VAL_290 + 1;
if (_chain_291 < 0) throw new Error("chain check");
export const VAL_291: number = 1291;

export class Cls_291 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_291`
