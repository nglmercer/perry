...
// Module #090 in the #808 init-scale chain. Each module imports its
...
const _chain_090: number = VAL_089 + 1;
if (_chain_090 < 0) throw new Error("chain check");
export const VAL_090: number = 1090;

export class Cls_090 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_090`
