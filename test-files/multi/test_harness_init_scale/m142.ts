...
// Module #142 in the #808 init-scale chain. Each module imports its
...
const _chain_142: number = VAL_141 + 1;
if (_chain_142 < 0) throw new Error("chain check");
export const VAL_142: number = 1142;

export class Cls_142 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_142`
