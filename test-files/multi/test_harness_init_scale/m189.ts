...
// Module #189 in the #808 init-scale chain. Each module imports its
...
const _chain_189: number = VAL_188 + 1;
if (_chain_189 < 0) throw new Error("chain check");
export const VAL_189: number = 1189;

export class Cls_189 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_189`
