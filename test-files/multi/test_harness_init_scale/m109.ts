...
// Module #109 in the #808 init-scale chain. Each module imports its
...
const _chain_109: number = VAL_108 + 1;
if (_chain_109 < 0) throw new Error("chain check");
export const VAL_109: number = 1109;

export class Cls_109 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_109`
