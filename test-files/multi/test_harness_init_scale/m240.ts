...
// Module #240 in the #808 init-scale chain. Each module imports its
...
const _chain_240: number = VAL_239 + 1;
if (_chain_240 < 0) throw new Error("chain check");
export const VAL_240: number = 1240;

export class Cls_240 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_240`
