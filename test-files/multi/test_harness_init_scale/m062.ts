...
// Module #062 in the #808 init-scale chain. Each module imports its
...
const _chain_062: number = VAL_061 + 1;
if (_chain_062 < 0) throw new Error("chain check");
export const VAL_062: number = 1062;

export class Cls_062 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_062`
