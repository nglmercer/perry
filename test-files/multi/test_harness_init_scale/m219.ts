...
// Module #219 in the #808 init-scale chain. Each module imports its
...
const _chain_219: number = VAL_218 + 1;
if (_chain_219 < 0) throw new Error("chain check");
export const VAL_219: number = 1219;

export class Cls_219 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_219`
