...
// Module #131 in the #808 init-scale chain. Each module imports its
...
const _chain_131: number = VAL_130 + 1;
if (_chain_131 < 0) throw new Error("chain check");
export const VAL_131: number = 1131;

export class Cls_131 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_131`
