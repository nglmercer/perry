...
// Module #275 in the #808 init-scale chain. Each module imports its
...
const _chain_275: number = VAL_274 + 1;
if (_chain_275 < 0) throw new Error("chain check");
export const VAL_275: number = 1275;

export class Cls_275 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_275`
