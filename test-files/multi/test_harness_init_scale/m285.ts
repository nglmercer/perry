...
// Module #285 in the #808 init-scale chain. Each module imports its
...
const _chain_285: number = VAL_284 + 1;
if (_chain_285 < 0) throw new Error("chain check");
export const VAL_285: number = 1285;

export class Cls_285 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_285`
