...
// Module #262 in the #808 init-scale chain. Each module imports its
...
const _chain_262: number = VAL_261 + 1;
if (_chain_262 < 0) throw new Error("chain check");
export const VAL_262: number = 1262;

export class Cls_262 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_262`
