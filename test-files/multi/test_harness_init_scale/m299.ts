...
// Module #299 in the #808 init-scale chain. Each module imports its
...
const _chain_299: number = VAL_298 + 1;
if (_chain_299 < 0) throw new Error("chain check");
export const VAL_299: number = 1299;

export class Cls_299 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_299`
