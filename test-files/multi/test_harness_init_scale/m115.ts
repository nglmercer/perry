...
// Module #115 in the #808 init-scale chain. Each module imports its
...
const _chain_115: number = VAL_114 + 1;
if (_chain_115 < 0) throw new Error("chain check");
export const VAL_115: number = 1115;

export class Cls_115 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_115`
