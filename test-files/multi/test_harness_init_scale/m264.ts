...
// Module #264 in the #808 init-scale chain. Each module imports its
...
const _chain_264: number = VAL_263 + 1;
if (_chain_264 < 0) throw new Error("chain check");
export const VAL_264: number = 1264;

export class Cls_264 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_264`
