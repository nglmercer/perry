...
// Module #055 in the #808 init-scale chain. Each module imports its
...
const _chain_055: number = VAL_054 + 1;
if (_chain_055 < 0) throw new Error("chain check");
export const VAL_055: number = 1055;

export class Cls_055 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_055`
