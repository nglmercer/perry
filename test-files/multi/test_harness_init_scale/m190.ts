...
// Module #190 in the #808 init-scale chain. Each module imports its
...
const _chain_190: number = VAL_189 + 1;
if (_chain_190 < 0) throw new Error("chain check");
export const VAL_190: number = 1190;

export class Cls_190 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_190`
