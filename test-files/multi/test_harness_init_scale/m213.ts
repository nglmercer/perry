...
// Module #213 in the #808 init-scale chain. Each module imports its
...
const _chain_213: number = VAL_212 + 1;
if (_chain_213 < 0) throw new Error("chain check");
export const VAL_213: number = 1213;

export class Cls_213 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_213`
