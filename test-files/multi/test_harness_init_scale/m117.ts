...
// Module #117 in the #808 init-scale chain. Each module imports its
...
const _chain_117: number = VAL_116 + 1;
if (_chain_117 < 0) throw new Error("chain check");
export const VAL_117: number = 1117;

export class Cls_117 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_117`
