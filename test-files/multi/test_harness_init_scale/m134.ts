...
// Module #134 in the #808 init-scale chain. Each module imports its
...
const _chain_134: number = VAL_133 + 1;
if (_chain_134 < 0) throw new Error("chain check");
export const VAL_134: number = 1134;

export class Cls_134 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_134`
