...
// Module #100 in the #808 init-scale chain. Each module imports its
...
const _chain_100: number = VAL_099 + 1;
if (_chain_100 < 0) throw new Error("chain check");
export const VAL_100: number = 1100;

export class Cls_100 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_100`
