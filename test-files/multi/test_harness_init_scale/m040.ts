...
// Module #040 in the #808 init-scale chain. Each module imports its
...
const _chain_040: number = VAL_039 + 1;
if (_chain_040 < 0) throw new Error("chain check");
export const VAL_040: number = 1040;

export class Cls_040 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_040`
