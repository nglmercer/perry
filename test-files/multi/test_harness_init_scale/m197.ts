...
// Module #197 in the #808 init-scale chain. Each module imports its
...
const _chain_197: number = VAL_196 + 1;
if (_chain_197 < 0) throw new Error("chain check");
export const VAL_197: number = 1197;

export class Cls_197 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_197`
