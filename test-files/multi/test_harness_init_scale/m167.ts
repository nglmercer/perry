...
// Module #167 in the #808 init-scale chain. Each module imports its
...
const _chain_167: number = VAL_166 + 1;
if (_chain_167 < 0) throw new Error("chain check");
export const VAL_167: number = 1167;

export class Cls_167 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_167`
