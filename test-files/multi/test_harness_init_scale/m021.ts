...
// Module #021 in the #808 init-scale chain. Each module imports its
...
const _chain_021: number = VAL_020 + 1;
if (_chain_021 < 0) throw new Error("chain check");
export const VAL_021: number = 1021;

export class Cls_021 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_021`
