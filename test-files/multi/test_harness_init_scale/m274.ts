...
// Module #274 in the #808 init-scale chain. Each module imports its
...
const _chain_274: number = VAL_273 + 1;
if (_chain_274 < 0) throw new Error("chain check");
export const VAL_274: number = 1274;

export class Cls_274 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_274`
