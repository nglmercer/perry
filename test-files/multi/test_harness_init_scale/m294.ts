...
// Module #294 in the #808 init-scale chain. Each module imports its
...
const _chain_294: number = VAL_293 + 1;
if (_chain_294 < 0) throw new Error("chain check");
export const VAL_294: number = 1294;

export class Cls_294 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_294`
