...
// Module #025 in the #808 init-scale chain. Each module imports its
...
const _chain_025: number = VAL_024 + 1;
if (_chain_025 < 0) throw new Error("chain check");
export const VAL_025: number = 1025;

export class Cls_025 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_025`
