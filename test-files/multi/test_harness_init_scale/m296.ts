...
// Module #296 in the #808 init-scale chain. Each module imports its
...
const _chain_296: number = VAL_295 + 1;
if (_chain_296 < 0) throw new Error("chain check");
export const VAL_296: number = 1296;

export class Cls_296 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_296`
