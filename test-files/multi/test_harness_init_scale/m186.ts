...
// Module #186 in the #808 init-scale chain. Each module imports its
...
const _chain_186: number = VAL_185 + 1;
if (_chain_186 < 0) throw new Error("chain check");
export const VAL_186: number = 1186;

export class Cls_186 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_186`
