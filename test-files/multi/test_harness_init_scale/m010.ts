...
// Module #010 in the #808 init-scale chain. Each module imports its
...
const _chain_010: number = VAL_009 + 1;
if (_chain_010 < 0) throw new Error("chain check");
export const VAL_010: number = 1010;

export class Cls_010 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_010`
