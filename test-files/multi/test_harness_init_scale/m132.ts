...
// Module #132 in the #808 init-scale chain. Each module imports its
...
const _chain_132: number = VAL_131 + 1;
if (_chain_132 < 0) throw new Error("chain check");
export const VAL_132: number = 1132;

export class Cls_132 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_132`
