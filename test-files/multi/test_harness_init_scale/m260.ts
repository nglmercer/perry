...
// Module #260 in the #808 init-scale chain. Each module imports its
...
const _chain_260: number = VAL_259 + 1;
if (_chain_260 < 0) throw new Error("chain check");
export const VAL_260: number = 1260;

export class Cls_260 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_260`
