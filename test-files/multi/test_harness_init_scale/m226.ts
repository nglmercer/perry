...
// Module #226 in the #808 init-scale chain. Each module imports its
...
const _chain_226: number = VAL_225 + 1;
if (_chain_226 < 0) throw new Error("chain check");
export const VAL_226: number = 1226;

export class Cls_226 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_226`
