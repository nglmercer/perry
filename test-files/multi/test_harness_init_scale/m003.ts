...
// Module #003 in the #808 init-scale chain. Each module imports its
...
const _chain_003: number = VAL_002 + 1;
if (_chain_003 < 0) throw new Error("chain check");
export const VAL_003: number = 1003;

export class Cls_003 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_003`
