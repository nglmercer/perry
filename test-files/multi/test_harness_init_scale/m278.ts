...
// Module #278 in the #808 init-scale chain. Each module imports its
...
const _chain_278: number = VAL_277 + 1;
if (_chain_278 < 0) throw new Error("chain check");
export const VAL_278: number = 1278;

export class Cls_278 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_278`
