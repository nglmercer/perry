...
// Module #047 in the #808 init-scale chain. Each module imports its
...
const _chain_047: number = VAL_046 + 1;
if (_chain_047 < 0) throw new Error("chain check");
export const VAL_047: number = 1047;

export class Cls_047 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_047`
