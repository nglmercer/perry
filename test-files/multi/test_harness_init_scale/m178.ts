...
// Module #178 in the #808 init-scale chain. Each module imports its
...
const _chain_178: number = VAL_177 + 1;
if (_chain_178 < 0) throw new Error("chain check");
export const VAL_178: number = 1178;

export class Cls_178 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_178`
