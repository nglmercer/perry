...
// Module #286 in the #808 init-scale chain. Each module imports its
...
const _chain_286: number = VAL_285 + 1;
if (_chain_286 < 0) throw new Error("chain check");
export const VAL_286: number = 1286;

export class Cls_286 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_286`
