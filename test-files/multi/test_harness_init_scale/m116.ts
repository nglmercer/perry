...
// Module #116 in the #808 init-scale chain. Each module imports its
...
const _chain_116: number = VAL_115 + 1;
if (_chain_116 < 0) throw new Error("chain check");
export const VAL_116: number = 1116;

export class Cls_116 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_116`
