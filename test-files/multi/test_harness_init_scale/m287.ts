...
// Module #287 in the #808 init-scale chain. Each module imports its
...
const _chain_287: number = VAL_286 + 1;
if (_chain_287 < 0) throw new Error("chain check");
export const VAL_287: number = 1287;

export class Cls_287 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_287`
