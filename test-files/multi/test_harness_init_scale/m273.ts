...
// Module #273 in the #808 init-scale chain. Each module imports its
...
const _chain_273: number = VAL_272 + 1;
if (_chain_273 < 0) throw new Error("chain check");
export const VAL_273: number = 1273;

export class Cls_273 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_273`
