...
// Module #166 in the #808 init-scale chain. Each module imports its
...
const _chain_166: number = VAL_165 + 1;
if (_chain_166 < 0) throw new Error("chain check");
export const VAL_166: number = 1166;

export class Cls_166 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_166`
