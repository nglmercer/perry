...
// Module #097 in the #808 init-scale chain. Each module imports its
...
const _chain_097: number = VAL_096 + 1;
if (_chain_097 < 0) throw new Error("chain check");
export const VAL_097: number = 1097;

export class Cls_097 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_097`
