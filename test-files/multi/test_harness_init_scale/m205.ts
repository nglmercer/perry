...
// Module #205 in the #808 init-scale chain. Each module imports its
...
const _chain_205: number = VAL_204 + 1;
if (_chain_205 < 0) throw new Error("chain check");
export const VAL_205: number = 1205;

export class Cls_205 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_205`
