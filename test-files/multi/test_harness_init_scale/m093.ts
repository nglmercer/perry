...
// Module #093 in the #808 init-scale chain. Each module imports its
...
const _chain_093: number = VAL_092 + 1;
if (_chain_093 < 0) throw new Error("chain check");
export const VAL_093: number = 1093;

export class Cls_093 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_093`
