...
// Module #103 in the #808 init-scale chain. Each module imports its
...
const _chain_103: number = VAL_102 + 1;
if (_chain_103 < 0) throw new Error("chain check");
export const VAL_103: number = 1103;

export class Cls_103 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_103`
