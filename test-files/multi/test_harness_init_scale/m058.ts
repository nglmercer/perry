...
// Module #058 in the #808 init-scale chain. Each module imports its
...
const _chain_058: number = VAL_057 + 1;
if (_chain_058 < 0) throw new Error("chain check");
export const VAL_058: number = 1058;

export class Cls_058 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_058`
