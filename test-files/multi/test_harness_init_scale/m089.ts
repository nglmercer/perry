...
// Module #089 in the #808 init-scale chain. Each module imports its
...
const _chain_089: number = VAL_088 + 1;
if (_chain_089 < 0) throw new Error("chain check");
export const VAL_089: number = 1089;

export class Cls_089 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_089`
