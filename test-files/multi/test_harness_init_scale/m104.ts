...
// Module #104 in the #808 init-scale chain. Each module imports its
...
const _chain_104: number = VAL_103 + 1;
if (_chain_104 < 0) throw new Error("chain check");
export const VAL_104: number = 1104;

export class Cls_104 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_104`
