...
// Module #191 in the #808 init-scale chain. Each module imports its
...
const _chain_191: number = VAL_190 + 1;
if (_chain_191 < 0) throw new Error("chain check");
export const VAL_191: number = 1191;

export class Cls_191 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_191`
