...
// Module #035 in the #808 init-scale chain. Each module imports its
...
const _chain_035: number = VAL_034 + 1;
if (_chain_035 < 0) throw new Error("chain check");
export const VAL_035: number = 1035;

export class Cls_035 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_035`
