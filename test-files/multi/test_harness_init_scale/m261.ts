...
// Module #261 in the #808 init-scale chain. Each module imports its
...
const _chain_261: number = VAL_260 + 1;
if (_chain_261 < 0) throw new Error("chain check");
export const VAL_261: number = 1261;

export class Cls_261 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_261`
