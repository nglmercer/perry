...
// Module #086 in the #808 init-scale chain. Each module imports its
...
const _chain_086: number = VAL_085 + 1;
if (_chain_086 < 0) throw new Error("chain check");
export const VAL_086: number = 1086;

export class Cls_086 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_086`
