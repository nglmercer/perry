...
// Module #141 in the #808 init-scale chain. Each module imports its
...
const _chain_141: number = VAL_140 + 1;
if (_chain_141 < 0) throw new Error("chain check");
export const VAL_141: number = 1141;

export class Cls_141 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_141`
