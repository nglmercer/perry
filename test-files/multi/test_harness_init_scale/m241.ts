...
// Module #241 in the #808 init-scale chain. Each module imports its
...
const _chain_241: number = VAL_240 + 1;
if (_chain_241 < 0) throw new Error("chain check");
export const VAL_241: number = 1241;

export class Cls_241 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_241`
