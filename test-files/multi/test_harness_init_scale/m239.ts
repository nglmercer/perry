...
// Module #239 in the #808 init-scale chain. Each module imports its
...
const _chain_239: number = VAL_238 + 1;
if (_chain_239 < 0) throw new Error("chain check");
export const VAL_239: number = 1239;

export class Cls_239 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_239`
