...
// Module #235 in the #808 init-scale chain. Each module imports its
...
const _chain_235: number = VAL_234 + 1;
if (_chain_235 < 0) throw new Error("chain check");
export const VAL_235: number = 1235;

export class Cls_235 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_235`
