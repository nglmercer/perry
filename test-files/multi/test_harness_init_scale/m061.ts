...
// Module #061 in the #808 init-scale chain. Each module imports its
...
const _chain_061: number = VAL_060 + 1;
if (_chain_061 < 0) throw new Error("chain check");
export const VAL_061: number = 1061;

export class Cls_061 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_061`
