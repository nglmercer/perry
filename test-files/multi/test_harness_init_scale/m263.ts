...
// Module #263 in the #808 init-scale chain. Each module imports its
...
const _chain_263: number = VAL_262 + 1;
if (_chain_263 < 0) throw new Error("chain check");
export const VAL_263: number = 1263;

export class Cls_263 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_263`
