...
// Module #125 in the #808 init-scale chain. Each module imports its
...
const _chain_125: number = VAL_124 + 1;
if (_chain_125 < 0) throw new Error("chain check");
export const VAL_125: number = 1125;

export class Cls_125 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_125`
