...
// Module #259 in the #808 init-scale chain. Each module imports its
...
const _chain_259: number = VAL_258 + 1;
if (_chain_259 < 0) throw new Error("chain check");
export const VAL_259: number = 1259;

export class Cls_259 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_259`
