...
// Module #120 in the #808 init-scale chain. Each module imports its
...
const _chain_120: number = VAL_119 + 1;
if (_chain_120 < 0) throw new Error("chain check");
export const VAL_120: number = 1120;

export class Cls_120 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_120`
