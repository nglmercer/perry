...
// Module #041 in the #808 init-scale chain. Each module imports its
...
const _chain_041: number = VAL_040 + 1;
if (_chain_041 < 0) throw new Error("chain check");
export const VAL_041: number = 1041;

export class Cls_041 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_041`
