...
// Module #027 in the #808 init-scale chain. Each module imports its
...
const _chain_027: number = VAL_026 + 1;
if (_chain_027 < 0) throw new Error("chain check");
export const VAL_027: number = 1027;

export class Cls_027 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_027`
