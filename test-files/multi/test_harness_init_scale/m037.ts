...
// Module #037 in the #808 init-scale chain. Each module imports its
...
const _chain_037: number = VAL_036 + 1;
if (_chain_037 < 0) throw new Error("chain check");
export const VAL_037: number = 1037;

export class Cls_037 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_037`
