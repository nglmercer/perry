...
// Module #283 in the #808 init-scale chain. Each module imports its
...
const _chain_283: number = VAL_282 + 1;
if (_chain_283 < 0) throw new Error("chain check");
export const VAL_283: number = 1283;

export class Cls_283 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_283`
