...
// Module #280 in the #808 init-scale chain. Each module imports its
...
const _chain_280: number = VAL_279 + 1;
if (_chain_280 < 0) throw new Error("chain check");
export const VAL_280: number = 1280;

export class Cls_280 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_280`
