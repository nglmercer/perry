...
// Module #018 in the #808 init-scale chain. Each module imports its
...
const _chain_018: number = VAL_017 + 1;
if (_chain_018 < 0) throw new Error("chain check");
export const VAL_018: number = 1018;

export class Cls_018 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_018`
