...
// Module #022 in the #808 init-scale chain. Each module imports its
...
const _chain_022: number = VAL_021 + 1;
if (_chain_022 < 0) throw new Error("chain check");
export const VAL_022: number = 1022;

export class Cls_022 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_022`
