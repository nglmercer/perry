...
// Module #177 in the #808 init-scale chain. Each module imports its
...
const _chain_177: number = VAL_176 + 1;
if (_chain_177 < 0) throw new Error("chain check");
export const VAL_177: number = 1177;

export class Cls_177 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_177`
