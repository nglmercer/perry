...
// Module #198 in the #808 init-scale chain. Each module imports its
...
const _chain_198: number = VAL_197 + 1;
if (_chain_198 < 0) throw new Error("chain check");
export const VAL_198: number = 1198;

export class Cls_198 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_198`
