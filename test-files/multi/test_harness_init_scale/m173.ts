...
// Module #173 in the #808 init-scale chain. Each module imports its
...
const _chain_173: number = VAL_172 + 1;
if (_chain_173 < 0) throw new Error("chain check");
export const VAL_173: number = 1173;

export class Cls_173 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_173`
