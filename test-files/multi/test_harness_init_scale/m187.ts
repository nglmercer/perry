...
// Module #187 in the #808 init-scale chain. Each module imports its
...
const _chain_187: number = VAL_186 + 1;
if (_chain_187 < 0) throw new Error("chain check");
export const VAL_187: number = 1187;

export class Cls_187 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_187`
