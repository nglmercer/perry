...
// Module #079 in the #808 init-scale chain. Each module imports its
...
const _chain_079: number = VAL_078 + 1;
if (_chain_079 < 0) throw new Error("chain check");
export const VAL_079: number = 1079;

export class Cls_079 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_079`
