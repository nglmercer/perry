...
// Module #297 in the #808 init-scale chain. Each module imports its
...
const _chain_297: number = VAL_296 + 1;
if (_chain_297 < 0) throw new Error("chain check");
export const VAL_297: number = 1297;

export class Cls_297 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_297`
