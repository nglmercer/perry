...
// Module #295 in the #808 init-scale chain. Each module imports its
...
const _chain_295: number = VAL_294 + 1;
if (_chain_295 < 0) throw new Error("chain check");
export const VAL_295: number = 1295;

export class Cls_295 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_295`
