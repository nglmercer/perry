...
// Module #248 in the #808 init-scale chain. Each module imports its
...
const _chain_248: number = VAL_247 + 1;
if (_chain_248 < 0) throw new Error("chain check");
export const VAL_248: number = 1248;

export class Cls_248 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_248`
