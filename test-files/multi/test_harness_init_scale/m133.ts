...
// Module #133 in the #808 init-scale chain. Each module imports its
...
const _chain_133: number = VAL_132 + 1;
if (_chain_133 < 0) throw new Error("chain check");
export const VAL_133: number = 1133;

export class Cls_133 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_133`
