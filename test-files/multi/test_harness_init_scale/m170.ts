...
// Module #170 in the #808 init-scale chain. Each module imports its
...
const _chain_170: number = VAL_169 + 1;
if (_chain_170 < 0) throw new Error("chain check");
export const VAL_170: number = 1170;

export class Cls_170 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_170`
