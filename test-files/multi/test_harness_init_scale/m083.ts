...
// Module #083 in the #808 init-scale chain. Each module imports its
...
const _chain_083: number = VAL_082 + 1;
if (_chain_083 < 0) throw new Error("chain check");
export const VAL_083: number = 1083;

export class Cls_083 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_083`
