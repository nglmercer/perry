...
// Module #203 in the #808 init-scale chain. Each module imports its
...
const _chain_203: number = VAL_202 + 1;
if (_chain_203 < 0) throw new Error("chain check");
export const VAL_203: number = 1203;

export class Cls_203 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_203`
