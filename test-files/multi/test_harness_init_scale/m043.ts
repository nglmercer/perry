...
// Module #043 in the #808 init-scale chain. Each module imports its
...
const _chain_043: number = VAL_042 + 1;
if (_chain_043 < 0) throw new Error("chain check");
export const VAL_043: number = 1043;

export class Cls_043 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_043`
