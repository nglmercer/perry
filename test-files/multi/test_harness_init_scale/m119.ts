...
// Module #119 in the #808 init-scale chain. Each module imports its
...
const _chain_119: number = VAL_118 + 1;
if (_chain_119 < 0) throw new Error("chain check");
export const VAL_119: number = 1119;

export class Cls_119 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_119`
