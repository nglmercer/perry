...
// Module #064 in the #808 init-scale chain. Each module imports its
...
const _chain_064: number = VAL_063 + 1;
if (_chain_064 < 0) throw new Error("chain check");
export const VAL_064: number = 1064;

export class Cls_064 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_064`
