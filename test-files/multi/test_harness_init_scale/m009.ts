...
// Module #009 in the #808 init-scale chain. Each module imports its
...
const _chain_009: number = VAL_008 + 1;
if (_chain_009 < 0) throw new Error("chain check");
export const VAL_009: number = 1009;

export class Cls_009 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_009`
