...
// Module #199 in the #808 init-scale chain. Each module imports its
...
const _chain_199: number = VAL_198 + 1;
if (_chain_199 < 0) throw new Error("chain check");
export const VAL_199: number = 1199;

export class Cls_199 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_199`
