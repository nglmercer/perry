...
// Module #212 in the #808 init-scale chain. Each module imports its
...
const _chain_212: number = VAL_211 + 1;
if (_chain_212 < 0) throw new Error("chain check");
export const VAL_212: number = 1212;

export class Cls_212 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_212`
