...
// Module #110 in the #808 init-scale chain. Each module imports its
...
const _chain_110: number = VAL_109 + 1;
if (_chain_110 < 0) throw new Error("chain check");
export const VAL_110: number = 1110;

export class Cls_110 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_110`
