...
// Module #164 in the #808 init-scale chain. Each module imports its
...
const _chain_164: number = VAL_163 + 1;
if (_chain_164 < 0) throw new Error("chain check");
export const VAL_164: number = 1164;

export class Cls_164 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_164`
