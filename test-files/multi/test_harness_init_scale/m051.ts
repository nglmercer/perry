...
// Module #051 in the #808 init-scale chain. Each module imports its
...
const _chain_051: number = VAL_050 + 1;
if (_chain_051 < 0) throw new Error("chain check");
export const VAL_051: number = 1051;

export class Cls_051 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_051`
