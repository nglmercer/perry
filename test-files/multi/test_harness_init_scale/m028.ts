...
// Module #028 in the #808 init-scale chain. Each module imports its
...
const _chain_028: number = VAL_027 + 1;
if (_chain_028 < 0) throw new Error("chain check");
export const VAL_028: number = 1028;

export class Cls_028 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_028`
