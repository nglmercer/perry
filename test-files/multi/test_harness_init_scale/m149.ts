...
// Module #149 in the #808 init-scale chain. Each module imports its
...
const _chain_149: number = VAL_148 + 1;
if (_chain_149 < 0) throw new Error("chain check");
export const VAL_149: number = 1149;

export class Cls_149 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_149`
