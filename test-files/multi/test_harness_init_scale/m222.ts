...
// Module #222 in the #808 init-scale chain. Each module imports its
...
const _chain_222: number = VAL_221 + 1;
if (_chain_222 < 0) throw new Error("chain check");
export const VAL_222: number = 1222;

export class Cls_222 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_222`
