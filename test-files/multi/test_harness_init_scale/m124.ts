...
// Module #124 in the #808 init-scale chain. Each module imports its
...
const _chain_124: number = VAL_123 + 1;
if (_chain_124 < 0) throw new Error("chain check");
export const VAL_124: number = 1124;

export class Cls_124 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_124`
