...
// Module #008 in the #808 init-scale chain. Each module imports its
...
const _chain_008: number = VAL_007 + 1;
if (_chain_008 < 0) throw new Error("chain check");
export const VAL_008: number = 1008;

export class Cls_008 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_008`
