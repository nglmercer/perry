...
// Module #232 in the #808 init-scale chain. Each module imports its
...
const _chain_232: number = VAL_231 + 1;
if (_chain_232 < 0) throw new Error("chain check");
export const VAL_232: number = 1232;

export class Cls_232 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_232`
