...
// Module #015 in the #808 init-scale chain. Each module imports its
...
const _chain_015: number = VAL_014 + 1;
if (_chain_015 < 0) throw new Error("chain check");
export const VAL_015: number = 1015;

export class Cls_015 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_015`
