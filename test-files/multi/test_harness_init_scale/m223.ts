...
// Module #223 in the #808 init-scale chain. Each module imports its
...
const _chain_223: number = VAL_222 + 1;
if (_chain_223 < 0) throw new Error("chain check");
export const VAL_223: number = 1223;

export class Cls_223 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_223`
