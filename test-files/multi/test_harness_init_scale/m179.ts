...
// Module #179 in the #808 init-scale chain. Each module imports its
...
const _chain_179: number = VAL_178 + 1;
if (_chain_179 < 0) throw new Error("chain check");
export const VAL_179: number = 1179;

export class Cls_179 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_179`
