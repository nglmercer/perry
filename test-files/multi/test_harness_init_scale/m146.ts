...
// Module #146 in the #808 init-scale chain. Each module imports its
...
const _chain_146: number = VAL_145 + 1;
if (_chain_146 < 0) throw new Error("chain check");
export const VAL_146: number = 1146;

export class Cls_146 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_146`
