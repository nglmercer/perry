...
// Module #161 in the #808 init-scale chain. Each module imports its
...
const _chain_161: number = VAL_160 + 1;
if (_chain_161 < 0) throw new Error("chain check");
export const VAL_161: number = 1161;

export class Cls_161 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_161`
