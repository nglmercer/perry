...
// Module #244 in the #808 init-scale chain. Each module imports its
...
const _chain_244: number = VAL_243 + 1;
if (_chain_244 < 0) throw new Error("chain check");
export const VAL_244: number = 1244;

export class Cls_244 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_244`
