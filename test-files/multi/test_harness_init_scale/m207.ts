...
// Module #207 in the #808 init-scale chain. Each module imports its
...
const _chain_207: number = VAL_206 + 1;
if (_chain_207 < 0) throw new Error("chain check");
export const VAL_207: number = 1207;

export class Cls_207 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_207`
