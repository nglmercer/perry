...
// Module #033 in the #808 init-scale chain. Each module imports its
...
const _chain_033: number = VAL_032 + 1;
if (_chain_033 < 0) throw new Error("chain check");
export const VAL_033: number = 1033;

export class Cls_033 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_033`
