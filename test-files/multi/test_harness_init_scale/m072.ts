...
// Module #072 in the #808 init-scale chain. Each module imports its
...
const _chain_072: number = VAL_071 + 1;
if (_chain_072 < 0) throw new Error("chain check");
export const VAL_072: number = 1072;

export class Cls_072 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_072`
