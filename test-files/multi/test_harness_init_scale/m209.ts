...
// Module #209 in the #808 init-scale chain. Each module imports its
...
const _chain_209: number = VAL_208 + 1;
if (_chain_209 < 0) throw new Error("chain check");
export const VAL_209: number = 1209;

export class Cls_209 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_209`
