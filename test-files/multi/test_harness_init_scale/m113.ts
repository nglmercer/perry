...
// Module #113 in the #808 init-scale chain. Each module imports its
...
const _chain_113: number = VAL_112 + 1;
if (_chain_113 < 0) throw new Error("chain check");
export const VAL_113: number = 1113;

export class Cls_113 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_113`
