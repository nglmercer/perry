...
// Module #111 in the #808 init-scale chain. Each module imports its
...
const _chain_111: number = VAL_110 + 1;
if (_chain_111 < 0) throw new Error("chain check");
export const VAL_111: number = 1111;

export class Cls_111 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_111`
