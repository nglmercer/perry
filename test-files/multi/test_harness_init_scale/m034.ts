...
// Module #034 in the #808 init-scale chain. Each module imports its
...
const _chain_034: number = VAL_033 + 1;
if (_chain_034 < 0) throw new Error("chain check");
export const VAL_034: number = 1034;

export class Cls_034 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_034`
