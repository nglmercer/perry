...
// Module #269 in the #808 init-scale chain. Each module imports its
...
const _chain_269: number = VAL_268 + 1;
if (_chain_269 < 0) throw new Error("chain check");
export const VAL_269: number = 1269;

export class Cls_269 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_269`
