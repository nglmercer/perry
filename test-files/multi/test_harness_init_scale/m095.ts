...
// Module #095 in the #808 init-scale chain. Each module imports its
...
const _chain_095: number = VAL_094 + 1;
if (_chain_095 < 0) throw new Error("chain check");
export const VAL_095: number = 1095;

export class Cls_095 {
  // `tag()` returns a string baked from the module index. After 300+
  // inits, Perry must still dispatch this method on a `Cls_095`
